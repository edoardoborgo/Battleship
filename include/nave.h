...
#define BATTLESHIP_NAVE_H
    ...
    class nave{
      public:
        static char simbolo = 'c';
        Coordinate centro;
        int dimensione = 0;
        //todo risolvere int corazza[dimensione];
        bool is_orizzontale = false;
         ...
         */
        bool is_nave(Coordinate &prua, Coordinate &poppa, int ideal_length);
        /*
         ...
         */
        void calcolo_verso(Coordinate &prua, Coordinate &poppa);
        /*
         *  calcolo_centro: date le coordinate di prua e poppa calcola la coordinata centrale e setta @param centro.
         */
        void calcolo_centro(Coordinate &prua, Coordinate &poppa);
        /*
         ...
         */
        void sposta_centro(Coordinate &centro);
        /*
         ...
         */
        void set_corazza(Coordinate &coord);
        /*
