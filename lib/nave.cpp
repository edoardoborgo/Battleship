...
void Nave::calcolo_centro(battaglia_navale::Coordinate &prua, battaglia_navale::Coordinate &poppa) {
    if (is_orizzontale_ == false) { //se la nave e verticale lavora con le y
